...
public class WaterFX : MonoBehaviour {
    ...
    public string m_NName= "WaterPlane";
	...
	void Start () {
		...
		if(m_cameraComponent == null)
        {
            ...
            //Camera.main.GetUniversalAdditionalCameraData().cameraStack.Add(m_cameraComponent);
        }
		...
		if(m_targetCamera != null)
		{
            ...
            m_waterObject = GameObject.Find(m_NName);
            if (m_waterObject == null)
            {
                m_waterObject = new GameObject(m_NName);
            }
			...
			int width = (int)(m_targetCamera.pixelWidth*2f);
