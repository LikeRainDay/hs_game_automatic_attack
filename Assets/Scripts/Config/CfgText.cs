...
using System.Collections.Generic;
    ...
    public class CfgText
    {
        ...
        private RowCfgText ParseRow(string[] col)
        {
            ...
            data.contents = new string[3];
            data.contents[0] = CsvUtility.ToString(rowHelper.ReadNextCol()); //中文翻译
            data.contents[1] = CsvUtility.ToString(rowHelper.ReadNextCol()); //中文翻译
            data.contents[2] = CsvUtility.ToString(rowHelper.ReadNextCol()); //中文翻译
            return data;
        }
    }
